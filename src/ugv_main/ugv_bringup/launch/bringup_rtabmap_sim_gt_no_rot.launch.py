...
def generate_launch_description():
    ...
    # the odom -> tf stuff is owned by the ground_truth_republish node
    ...
    nav2_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            'params_file': 'nav2_rtabmap_sim_no_rot_params.yaml',
            'use_sim_time': 'true'
        }.items()
    )
    ...
    gt_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            'params_file': 'ground_truth_republish_sim_params.yaml',
            'use_sim_time': 'true'
        }.items()
    )
    ...
    gazebo_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
          os.path.join(get_package_share_directory('gazebo_differential_drive_robot_4wheel'), 'launch', 'ugv_gt.launch.py')
        ),
        launch_arguments={
